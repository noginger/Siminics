/*编辑器样式*/
/*1、迷你样式*/
var mini = [['fullscreen', 'insertimage', '|', 'link', 'unlink', 'anchor', '|', 'forecolor', 'fontfamily', 'fontsize', '|', 'bold', 'italic', 'underline', 'strikethrough', 'superscript', 'subscript', 'removeformat', 'formatmatch', 'autotypeset', '|', 'lineheight', 'indent', 'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|', 'selectall', 'cleardoc', '|', 'rowspacingtop', 'rowspacingbottom', 'lineheight', '|', 'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', '|']];
/*不含图片迷你样式*/
var noImage = [['fullscreen', 'link', 'unlink', 'anchor', '|', 'forecolor', 'fontfamily', 'fontsize', '|', 'bold', 'italic', 'underline', 'strikethrough', 'superscript', 'subscript', 'removeformat', 'formatmatch', 'autotypeset', '|', 'lineheight', 'indent', 'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|', 'selectall', 'cleardoc', '|', 'rowspacingtop', 'rowspacingbottom', 'lineheight', '|',
...
(function () {
    ...
    */
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        , imageUrl: "http://img.kudongyi.com/Handler/EditorUp.ashx"             //图片上传提交地址
        ...
        //涂鸦图片配置区
        , scrawlUrl: URL + "Handler/scrawlUp.ashx"           //涂鸦上传地址
        , scrawlPath: URL + "Handler/"                           //图片修正地址，同imagePath

        //附件上传配置区
        , fileUrl: URL + "Handler/fileUp.ashx"               //附件上传提交地址
        , filePath: URL + "Handler/"                   //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

        //远程抓取配置区
        , catchRemoteImageEnable: false               //是否开启远程图片抓取,默认开启
        , catcherUrl: URL + "Handler/getRemoteImage.ashx"   //处理远程图片抓取的地址
        ...
        //图片在线管理配置区
        , imageManagerUrl: URL + "Handler/imageManager.ashx"       //图片在线管理的处理地址
        , imageManagerPath: ""                                    //图片修正地址，同imagePath

        //屏幕截图配置区
        , snapscreenHost: '127.0.0.1'                                  //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        , snapscreenServerUrl: URL + "Handler/imageUp.ashx" //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/php/snapImgUp.php"”
        , snapscreenPath: URL + "Handler/"
        //,snapscreenServerPort: 80                                    //屏幕截图的server端端口
        //,snapscreenImgAlign: 'center'                                //截图的图片默认的排版方式

        //word转存配置区
        , wordImageUrl: URL + "Handler/ImageUploder.ashx"              //word转存提交地址
        , wordImagePath: URL + "Handler/"                       //
        //,wordImageFieldName:"upfile"                     //word转存表单名若此处修改，需要在后台对应文件修改对应参数

        //获取视频数据的地址
        , getMovieUrl: URL + "Handler/getMovie.ashx"                   //视频数据获取地址
